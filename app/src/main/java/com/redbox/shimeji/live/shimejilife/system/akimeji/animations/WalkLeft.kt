...
class WalkLeft(akimejit2Id: Int) : Walk(akimejit2Id) {
    ...
    override fun getSprites(): MutableList<SpriteT2> {
        ...
        when (akimejit2Id) {
            ...
            3 -> {
                spritesLen.add(SpriteT2(0, -0.8f, 0, 15))
                spritesLen.add(SpriteT2(1, -0.8f, 0, 15))
                return spritesLen
            }
            4 -> {
                spritesTaku.add(SpriteT2(0, -0.8f, 0, 20))
                spritesTaku.add(SpriteT2(1, -0.8f, 0, 20))
                spritesTaku.add(SpriteT2(2, -0.8f, 0, 20))
                spritesTaku.add(SpriteT2(3, -0.8f, 0, 20))
                spritesTaku.add(SpriteT2(4, -0.8f, 0, 20))
                return spritesTaku
            }
            5 -> {
